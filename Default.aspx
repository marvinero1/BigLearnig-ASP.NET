	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(public/images/blog-1.jpg);">
				...
				<div class="row">
					<div class="col-md-12 animate-box">
						<div class="owl-carousel">
							...
							<div class="item">
								<div class="classes">
									<div class="classes-img" style="background-image: url(public/images/classes-4.jpg);">
									</div>
									<div class="wrap">
										<div class="desc">
											<span class="teacher">David Clarson</span>
							...
							<div class="item">
								<div class="classes">
									<div class="classes-img" style="background-image: url(public/images/classes-5.jpg);">
									</div>
									<div class="wrap">
										<div class="desc">
											<span class="teacher">David Clarson</span>
			...
			<div class="container">
				<div class="col-md-7">
					<div class="about-desc">
						<div class="about-img-1 animate-box" style="background-image: url(public/images/about-img-2.jpg);"></div>
						<div class="about-img-2 animate-box" style="background-image: url(public/images/about-img-1.jpg);"></div>
					</div>
				</div>
				<div class="col-md-5">
					<div class="row">
		...
		<div id="colorlib-testimony" class="testimony-img" style="background-image: url(public/images/img_bg_2.jpg); margin-bottom: 4em;" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container-fluid">
				<div class="row">
				...
				<div class="row">
					<div class="col-md-3 col-sm-3 animate-box">
						<div class="trainers-entry">
							...
							<div class="trainer-img" style="background-image: url(public/images/person1.jpg)"></div>
						</div>
					</div>
					...
					<div class="col-md-3 col-sm-3 animate-box">
						<div class="trainers-entry">
							...
							<div class="trainer-img" style="background-image: url(public/images/person2.jpg)"></div>
						</div>
					</div>
					...
					<div class="col-md-3 col-sm-3 animate-box">
						<div class="trainers-entry">
							...
							<div class="trainer-img" style="background-image: url(public/images/person3.jpg)"></div>
						</div>
					</div>
					...
					<div class="col-md-3 col-sm-3 animate-box">
						<div class="trainers-entry">
							...
							<div class="trainer-img" style="background-image: url(public/images/person4.jpg)"></div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="colorlib-classes">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 animate-box">
						<div class="classes">
							<div class="classes-img" style="background-image: url(public/images/classes-6.jpg);">
							</div>
							<div class="wrap">
								<div class="desc">
									<span class="teacher">David Clarson</span>
					...
					<div class="col-md-7 row-pb-md">
						...
						<div class="row">
							<div class="col-md-12">
					            ...
					            <a href="#" class="blog-img" style="background-image: url(public/images/blog-1.jpg);"></a>
					            <div class="text">
					         ...
					         <div class="block-21 d-flex animate-box">
					            <a href="#" class="blog-img" style="background-image: url(public/images/blog-2.jpg);"></a>
					            <div class="text">
					               <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
					               <p>ven the all-powerful Pointing has no control about the blind texts it is an almost</p>
					               <div class="meta">
					         ...
					         <div class="block-21 d-flex animate-box">
					            <a href="#" class="blog-img" style="background-image: url(public/images/blog-3.jpg);"></a>
					            <div class="text">
					               <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
					               <p>ven the all-powerful Pointing has no control about the blind texts it is an almost</p>
					               <div class="meta">
					         ...
					         <div class="block-21 d-flex animate-box">
					            <a href="#" class="blog-img" style="background-image: url(public/images/blog-4.jpg);"></a>
					            <div class="text">
					               <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
					               <p>ven the all-powerful Pointing has no control about the blind texts it is an almost</p>
					               <div class="meta">
